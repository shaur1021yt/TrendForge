...
const CALCULATORS: Record<string, (topic: Topic) => ToolSpec> = {
  'gaming': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'AMD Ryzen 7 9800X3D', category: 'CPU', description: 'Best gaming CPU 2025' },
      { name: 'NVIDIA RTX 5070', category: 'GPU', description: 'Best value 1440p GPU' },
      { name: 'G.Skill Trident Z5 32GB DDR5-6000', category: 'RAM', description: 'Fast DDR5 gaming memory' },
    ],
  ...
  'finance': (topic) => ({
    ...
    inputsSchema: {
      ...
      interestRate: { type: 'number', label: 'Interest Rate (%)', min: 1, max: 12, default: 6.9, step: 0.1 },
    ...
    affiliateProducts: [
      { name: 'Rocket Mortgage Pre-Approval', category: 'Finance', description: 'Get pre-approved online in minutes' },
      { name: 'LendingTree Home Insurance', category: 'Insurance', description: 'Compare home insurance quotes' },
      { name: 'Better.com Mortgage', category: 'Finance', description: 'Low rates, fast closing' },
    ],
  ...
  'fitness': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'Optimum Nutrition Gold Standard Whey', category: 'Supplements', description: 'Best-selling protein powder' },
      { name: 'Transparent Labs Whey Protein Isolate', category: 'Supplements', description: 'Clean, grass-fed protein' },
      { name: 'BulkSupplements Creatine Monohydrate', category: 'Supplements', description: 'Essential for muscle building' },
    ],
  ...
  'ai': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'ChatGPT Plus', category: 'AI Tools', description: '$20/mo — GPT-4o access' },
      { name: 'Claude Pro', category: 'AI Tools', description: '$20/mo — Anthropic Claude' },
      { name: 'Cursor Pro', category: 'AI Dev Tools', description: '$20/mo — AI coding assistant' },
    ],
  ...
  'career': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'LinkedIn Premium Career', category: 'Career', description: '$30/mo — InMail, insights, who viewed you' },
      { name: 'Teal Resume Builder', category: 'Career', description: 'AI-powered resume and job tracker' },
    ],
  ...
  'travel': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'Booking.com Hotels', category: 'Travel', description: 'Free cancellation on most bookings' },
      { name: 'Google Flights', category: 'Travel', description: 'Compare flight prices across airlines' },
      { name: 'Travel Insurance - World Nomads', category: 'Travel', description: 'Cover your trip from $49' },
    ],
  ...
  'shopping': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'MacBook Air M4', category: 'Laptops', description: 'Best overall laptop 2025' },
      { name: 'ASUS ROG Zephyrus G14 2025', category: 'Laptops', description: 'Best gaming laptop' },
      { name: 'ThinkPad X1 Carbon Gen 13', category: 'Laptops', description: 'Best business laptop' },
      { name: 'Framework Laptop 16', category: 'Laptops', description: 'Best modular/upgradeable laptop' },
    ],
  ...
  'lifestyle': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'The Knot Wedding Planner', category: 'Wedding', description: 'Free planning tools and vendor search' },
      { name: 'Zola Wedding Registry', category: 'Wedding', description: 'Modern registry with cash funds' },
      { name: 'Riley & Grey Wedding Website', category: 'Wedding', description: 'Beautiful wedding websites' },
    ],
  ...
  'home': (topic) => ({
    ...
    affiliateProducts: [
      { name: 'Tesla Solar Panels', category: 'Home', description: 'Residential solar — estimate savings' },
      { name: 'Emporia Vue Energy Monitor', category: 'Home', description: 'Real-time whole-home energy tracking ($149)' },
      { name: 'Ecobee Smart Thermostat', category: 'Home', description: 'Save up to 26% on heating/cooling' },
    ],
